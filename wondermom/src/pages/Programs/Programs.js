                    ...
                    <div className="card-deck">
                        <div className="card">
                            ...
                            <div className="card-body">
                                ...
                                <a href="/SixWeekProgram" id="tryThisButton" className="centerButton card-link">Try this program!</a>
                            </div>
                        </div>
                        <div className="card">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                                eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                <button id="tryThisButton" className="centerButton card-link">Try this program!</button>
                            </div>
                        </div>
                        <div className="card">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                                eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                <button className="centerButton card-link" id="tryThisButton">Try this program!</button>
                            </div>
                        </div>
                    </div>
                </div>
